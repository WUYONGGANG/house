...
public class BdFeedHouseTests {
	...
	{	 
		...
		params.add("companyId", "123456789");
		params.add("companyName", "8090公寓");
		params.add("fitmentState", "无");

		
		Gson gson = new Gson();
		params1.add("data", gson.toJson(params));
		params2.add("ak", "e6fad3af2ed870e176e7df8445c1e34fbfd463b7def3585df183cf3e6212997f");

		//调用接口，传入添加的用户参数
		String responseString = mockMvc
				.perform(post("/task/houseSubmit")
