...
//	}
	...
	{	 
		...
		params.add("sign", "fc2120fce603d91f3c27fd6d706634dcc285a9a9054eed33b85a7b31f5e2cb64");// 发布房源接口返回的token		
		//调用接口，传入添加的用户参数
		String responseString =  mockMvc.perform(post("/house/delHouse")
				.contentType(MediaType.APPLICATION_JSON_UTF8)
				.params(params))
				.andExpect(status().isOk())    //返回的状态是200
               .andReturn().getResponse().getContentAsString();   //将相应的数据转换为字符串	
