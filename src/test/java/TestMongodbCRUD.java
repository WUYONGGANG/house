 ...
 */  
public class TestMongodbCRUD {  
    private static Mongo m = null;  
    private static DB db = null;  
      
    //数据集合名称  
    private static final String COLLECTION_NAME = "tongcheng58_department_house_2017-03-27";  
...
//        stopMondoDBConn();  
    ...
    private static void readColData(){  
        ...
        while(ret.hasNext()){
            ...
            if(bdbObj != null){
                ...
                //System.out.println("phone_num:"+bdbObj.getString("phone_num"));  
            }  
        }  
    }  
    ...
    private static void startMongoDBConn(){  
        try {  
            ...
            m = new Mongo("123.56.114.1", 27017);  
            //根据mongodb数据库的名称获取mongodb对象  
            db = m.getDB("houses");  
            //校验用户密码是否正确  
            if (!db.authenticate("", "".toCharArray())){  
