...
public class RedisCacheManager {
    ...
    public String rightPop(String key)throws Exception{
        ListOperations<String, String> listOps = stringRedisTemplate.opsForList();
        log.info(LogUtils.getCommLog(String.format("[REDIS] rigthPop list key=%s", key)));
     ...
     * @throws Exception
     */
    public Long sizeList(String key) throws Exception {
        ListOperations<String, String> listOps = stringRedisTemplate.opsForList();
        log.info(LogUtils.getCommLog(String.format("[REDIS] sizeList key=%s", key)));
