...
public class HouseAszDao {
     ...
     * @param onlineStatus
     */
    public void updateHouseOnlineStatus(String  off,String on) {
        try{
            houseDetailAszRepository.updateHouseOnlineStatus(off,on);            
        }catch (Exception e) {
            throw new BaseException(ErrorMsgCode.ERROR_MSG_ADD_HOUSE_FAIL, "更新房源状态为下架失败");
        }
