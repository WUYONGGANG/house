 ...
 * @since JDK 1.8
 */
public interface MapHouseSolrRepository extends SolrCrudRepository<HouseSolrResult, Long>{

	GroupResult<HouseMapSolrResult> getAllByMultiCondition(MapHouseSearchDto houseSearchDto, List<String> agencyIdList);
