...
public class PlatformInterceptor implements HandlerInterceptor {
	...
	static {
        ...
        IGNORE_SESSION_INTERFACE_WHITELIST.add("/v3/bill/reqpaylist/");
        ...
        IGNORE_SESSION_INTERFACE_WHITELIST.add("/v1/pay/reqbugetpaiddetail/");
        IGNORE_SESSION_INTERFACE_WHITELIST.add("/v1/pay/reqcontractconfirm/");
	...
	static {
		...
		NO_CHECK_WHITELIST.add("/wx/reqwxqrcode/");
		NO_CHECK_WHITELIST.add("/wx/reqwxmsg/");
	}
	@Override
