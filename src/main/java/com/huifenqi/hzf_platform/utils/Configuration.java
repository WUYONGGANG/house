...
public class Configuration {
	...
	@Value("${hzf.time.quantum}")
	public String timeQuantum;

	@Value("${hfq.order.system.id}")
	public String orderSystemId;
	
	@Value("${hzf.rent.minpay.amount}")
    public String minPayAmount;
	
	@Value("${hzf.file.upload.url}")
    public String fileserver;
	
	@Value("${hzf.file.server.fastDFS.used}")
    public boolean usedFastDFS;

    @Value("${hzf.file.cache.path}")
    public String fileCachePath;
    
    @Value("${hzf.wx.signature.token}")
    public String token;
    
    @Value("${hzf.wx.imagemessage.title}")
    public String imageTitle;

    @Value("${hzf.wx.imagemessage.url}")
    public String wxPushUrl;

    @Value("${hzf.wx.imagemessage.description}")
    public String imageDescriptions;

    @Value("${hzf.wx.imagemessage.picurl}")
    public String imagePicurl;
    
    @Value("${hfq.wx.copywriter.common}")
    public String copywriterCommon;
