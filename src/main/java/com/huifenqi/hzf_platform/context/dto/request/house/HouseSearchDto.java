...
public class HouseSearchDto {
    ...
    public String toString() {
        return "HouseSearchDto [sellId=" + sellId + ", keyword=" + keyword + ", cityId=" + cityId + ", districtId="
                ...
                + communityName + ", companyType=" + companyType + ", denyList=" + denyList + ", companyOffList="
                + companyOffList + ", houseList=" + houseList + ", roomList=" + roomList + ", isHomePage=" + isHomePage
                + ", isCollect=" + isCollect + ", isFoot=" + isFoot + ", userId=" + userId + "]";
    }
