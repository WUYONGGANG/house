...
public class Constants {
	...
	public static class BlackPhoneUtil {
   ...
   public static class searchType {
        ...
        public static final int SEARCH_FOOT = 1;
        public static final int SEARCH_COLLECT = 1;
        public static final int SEARCH_HOMEPAGE = 1; 
        public static final String NOT_COLLECT_OR_FOOT = "-9999999";
...
//		}
	...
	public static class CommunityStatus {
        ...
        public static final int BAIDU_MAP_YES_FLAG = 1;

        public static final int BAIDU_MAP_NOT_FLAG = 0;
        
        public static final int BAIDU_MAP_INSERT_TYPE = 0;

        public static final int BAIDU_MAP_UPDATE_TYPE = 1;
        
        public static final int BAIDU_MAP_DELETE_TYPE = 2;

        public static final int BAIDU_MAP_SUCCESS_STATUS = 1;
        
        public static final int BAIDU_MAP_FAILE_STATUS = -1;

        public static final int BAIDU_MAP_INIT_STATUS = 0;
...
/** ====================================在线缴租相关常量信息start====================================  */
	...
	/** 合同生效状态(1：待生效；2：履行中；3：已到期) */
	public static class contractType {
		public static final int TO_BE_EFFECTIVE = 1;
		public static final int DURING_PERFORMANCE = 2;
		public static final int IS_EXPIRED = 3;
	}
	
	/** 账单类型(-1：全部；102：出租房租；110：其他账单；120：交定账单) */
    public static class financeType {
        ...
        public static final int DEPOSIT_FINANCE_TYPE = 120;
    }
	...
	static{
		...
		paymentTypeComment.put(2, "协议保留至");
	}
	...
	/** 合同确认文案提示 */
    public static Map<Integer,String> contractConfirmName;
    static{
        contractConfirmName = new HashMap<>();
        contractConfirmName.put(0, "确认合同后可以在线交租哦");
        contractConfirmName.put(1, "合同信息变更，确认后才能支付哦");
        contractConfirmName.put(2, "合同已确认");
        contractConfirmName.put(3, "交定账单不需要合同确认");
    }
    
    /** 合同分期状态 */
    public static Map<Integer,String> contractFQstatusName;
    static{
        contractFQstatusName = new HashMap<>();
        contractFQstatusName.put(1, "您的合同正在申请月付服务，请审核后再付款。");
        contractFQstatusName.put(2, "您的合同已经申请了月付服务，请联系经纪人核对账单后再支付。");
        contractFQstatusName.put(3, "");
    }
    
    /** 二次确认合同信息更改话术 */
    public static Map<Integer,String> changeDataType;
    static{
        changeDataType = new HashMap<>();
        changeDataType.put(1, "租期");
        changeDataType.put(2, "租金");
        changeDataType.put(3, "押金");
        changeDataType.put(4, "付款方式");
    }
    
    /** 合同付款类型话术 */
    public static Map<Integer,String> contractPaymentType;
    static{
        contractPaymentType = new HashMap<>();
        contractPaymentType.put(-1, "全额付");
        contractPaymentType.put(1, "月付");
        contractPaymentType.put(2, "二月付");
        contractPaymentType.put(3, "季付");
        contractPaymentType.put(4, "四月付");
        contractPaymentType.put(5, "五月付");
        contractPaymentType.put(6, "半年付");
        contractPaymentType.put(12, "年付");
    }
...
/** ====================================在线缴租相关常量信息end====================================  */
	...
	public static class WeixinQrCode {

        /**
         * 二维码缓存透传字符串
         */
        public static final String QRCODE_PARAM_PREFIX = "hzfqrcode_param_";

        /**
         * 二维码场景类型:数字
         */
        public static final int SENCE_TYPE_NUMBER = 1;

        /**
         * 二维码场景类型:字符串
         */
        public static final int SENCE_TYPE_STRING = 2;
    }
	
	//水印
    public static class Watermark {
        
        public static int WATERMARK_TYPE_YES = 1;
        
        public static int WATERMARK_TYPE_NO = 0;
    }
    
    public static class JmsConstants {

        // 目地为queue
        public static final int DESTINATION_QUEUE = 0;

        // 目地为Topic
        public static final int DESTINATION_TOPIC = 1;
    }
