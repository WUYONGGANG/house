...
public class CommunityBase {
     ...
     * 收集类型
     */
    @Column(name = "f_baidu_map_flag")
    private int baiduMapFlag;
    
    /**
     * 操作类型 0新增 1新增  2删除
     */
    @Column(name = "f_baidu_map_type")
    private int baiduMapType;
    
    
    /**
     * 同步状态 0未同步 1同步完成 -1同步失败
     */
    @Column(name = "f_baidu_map_status")
    private int baiduMapStatus;
	...
	public int getBaiduMapFlag() {
        return baiduMapFlag;
    }

	
    public int getBaiduMapType() {
        return baiduMapType;
    }

    public void setBaiduMapType(int baiduMapType) {
        this.baiduMapType = baiduMapType;
    }

    public int getBaiduMapStatus() {
        return baiduMapStatus;
    }

    public void setBaiduMapStatus(int baiduMapStatus) {
        this.baiduMapStatus = baiduMapStatus;
    }

    public void setBaiduMapFlag(int baiduMapFlag) {
        this.baiduMapFlag = baiduMapFlag;
    }
    ...
    public String toString() {
        return "CommunityBase [id=" + id + ", cityName=" + cityName + ", cityId=" + cityId + ", districtName="
                ...
                + precise + ", confidence=" + confidence + ", level=" + level + ", flag=" + flag + ", baiduMapFlag="
                + baiduMapFlag + ", baiduMapType=" + baiduMapType + ", baiduMapStatus=" + baiduMapStatus
