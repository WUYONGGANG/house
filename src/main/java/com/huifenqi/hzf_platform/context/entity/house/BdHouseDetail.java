 ...
 */
@Entity
@Table(name = "t_house_detail_extend")
public class BdHouseDetail {

	public BdHouseDetail() {
	}
	...
	public int getFaceToType() {
		return faceToType;
	}

	public void setFaceToType(int faceToType) {
	...
	public void setIsSaas(int isSaas) {
		this.isSaas = isSaas;
	}

	@Override
	public String toString() {
		return "BdHouseDetail [id=" + id + ", outHouseId=" + outHouseId + ", appId=" + appId + ", picUrlList="
