...
public class RentContractDetailVo {
    ...
    private int isElectronicContract;
    private String pdfContractUrl;
    private int isApplied;
    private int contractFQstatus;
    private String contractFQstatusName;
    ...
    public void setIsUseCA(int isUseCA) {
        this.isUseCA = isUseCA;
    }

    public String getElectronicContractUrl() {
        return electronicContractUrl;
    }

    public void setElectronicContractUrl(String electronicContractUrl) {
        this.electronicContractUrl = electronicContractUrl;
    }

    public int getIsElectronicContract() {
        return isElectronicContract;
    }

    public void setIsElectronicContract(int isElectronicContract) {
        this.isElectronicContract = isElectronicContract;
    }

    public String getPdfContractUrl() {
        return pdfContractUrl;
    }

    public void setPdfContractUrl(String pdfContractUrl) {
        this.pdfContractUrl = pdfContractUrl;
    }
    ...
    public int getContractFQstatus() {
        return contractFQstatus;
    }

    public void setContractFQstatus(int contractFQstatus) {
        this.contractFQstatus = contractFQstatus;
    }

    public String getContractFQstatusName() {
        return contractFQstatusName;
    }

    public void setContractFQstatusName(String contractFQstatusName) {
        this.contractFQstatusName = contractFQstatusName;
    }
    ...
    public String toString() {
        return "RentContractDetailVo{" +
                ...
                ", isApplied=" + isApplied +
                ", contractFQstatus=" + contractFQstatus +
                ", contractFQstatusName=" + contractFQstatusName +
                '}';
    }
}
