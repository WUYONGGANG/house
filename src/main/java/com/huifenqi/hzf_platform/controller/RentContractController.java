...
public class RentContractController {
	 ...
	 * @return
	 */
	@RequestMapping(value="/v1/ca/reqelectricalcontract", method = RequestMethod.POST)
	public Responses reqElectricalContract(HttpServletRequest request, HttpServletResponse response) throws Exception {
		return rentContractRequestHandler.reqElectricalContract(request);
	}
