...
public class DoorLockController {
	 ...
	 * @dateTime 2017年12月18日 下午4:32:25
	 */
	@RequestMapping(value = "/v2/doorlock/api/doorlocklist", method = RequestMethod.POST)
	public Responses getDoorLockListV2(HttpServletRequest request, HttpServletResponse response) {
		return doorLockRequestHandler.getDoorLockListV2();
	}
	/**
