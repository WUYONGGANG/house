...
public class SmartMeterController {
	 ...
	 * @dateTime 2018年1月17日 下午2:54:03
	 */
	@RequestMapping(value = "/v2/api/meter/createorder", method = RequestMethod.POST)
	public Responses createTradeOrderV2(HttpServletRequest request, HttpServletResponse response) {
		return smartMeterRequestHandler.reqCreateTradeOrderV2();
	}
	 ...
	 * @dateTime 2018年1月22日 下午2:54:03
	 */
	@RequestMapping(value = "/v2/api/meter/meterpaychannels", method = RequestMethod.POST)
	public Responses getPayChannelsV2(HttpServletRequest request, HttpServletResponse response) {
		return smartMeterRequestHandler.getPayChannelsV2();
	}
	 ...
	 * @dateTime 2018年1月22日 下午2:54:03
	 */
	@RequestMapping(value = "/v2/api/meter/reqchannelfee", method = RequestMethod.POST)
	public Responses reqChannelFeeV2(HttpServletRequest request, HttpServletResponse response) {
		return smartMeterRequestHandler.reqChannelFeeV2();
	}
