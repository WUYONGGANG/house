...
public class RentPayController {
	...
	@RequestMapping(value="/v3/bill/reqpaylist/", method = RequestMethod.POST)
	public Responses reqPayListV3(HttpServletRequest request, HttpServletResponse response) throws Exception {
	    return rentPayRequestHandler.reqPayListV3(request);
	}
	...
	/**
	 * 查询合同下的账单列表-30天内待支付的账单
	 * @return
     */
	@RequestMapping(value="/v1/bill/reqcontractneedpaylist/", method = RequestMethod.POST)
    public Responses reqContractNeedPayList(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return rentPayRequestHandler.reqContractNeedPayList(request);
    }
	 ...
	 * @return
	 */
	@RequestMapping(value="/v2/pay/reqpaymentchannellist/", method = RequestMethod.POST)
	public Responses reqPaymentchannellistV2(HttpServletRequest request, HttpServletResponse response) throws Exception {
		return rentPayRequestHandler.reqPaymentchannellistV2(request);
	}
	/**
	 * 查询渠道费
	 * @return
     ...
     * @return
     */
    @RequestMapping(value="/v1/pay/reqbugetpaiddetail/", method = RequestMethod.POST)
    public Responses reqBugetPaidDetail(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return rentPayRequestHandler.reqBugetPaidDetail(request);
    }
     ...
     * @return
     */
    @RequestMapping(value="/v1/pay/reqcontractconfirm/", method = RequestMethod.POST)
    public Responses reqContractConfirm(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return rentPayRequestHandler.reqContractConfirm(request);
    }
